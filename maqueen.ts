...
namespace maqueen {
    ...
    export enum Motors {
        //% blockId="left motor" block="왼쪽"
        M1 = 0,
        //% blockId="right motor" block="오른쪽"
        M2 = 1,
        //% blockId="all motor" block="모두"
        All = 2
    }
    ...
    export enum Dir {
        //% blockId="CW" block="앞으로"
        CW = 0x0,
        //% blockId="CCW" block="뒤로"
        CCW = 0x1
    }
    ...
    //% weight=2
    //% blockGap=50
    //% blockId=IR_callbackUser block="받은 IR에"
    ...
    //% weight=10
    //% blockId=IR_read block="IR 키 값 읽기"
    ...
    //% weight=5
    //% group="micro:bit(v2)"
    //% blockId=IR_readv2 block="IR 키 값 읽기"
    ...
    //% weight=2
    //% group="micro:bit(v2)"
    //% blockId=IR_callbackUserv2 block="받은 IR"
    //% draggableParameters
...
function valuotokeyConversion():number{
    ...
    //% weight=10
    //% blockId=IR_read_version block="버전 정보 얻기"
    ...
    //% weight=90
    //% blockId=motor_MotorRun block="모터|%index|움직임|%Dir|속도|%speed"
    ...
    //% weight=20
    //% blockId=motor_motorStop block="모터 |%motors 정지"
    ...
    //% weight=20
    //% blockId=read_Patrol block="읽기 |%patrol 라인 추적센서"
    ...
    //% weight=20
    //% blockId=writeLED block="LED라이트 |%led 설정 |%ledswitch"
    ...
    //% weight=90
    //% blockId=servo_ServoRun block="서보|%index|각도|%angle"
     ...
     */
    //% weight=2
    //% blockId=kb_event block="작동|%value 라인 추적센서|%vi"
